                    ...
                    <SectionObserver>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <a href="mailto:bookings@montbleu.co.za" className="text-sanctuary-blue/60 font-light hover:text-sanctuary-blue transition-colors">bookings@montbleu.co.za</a>
                            </div>
                            <div className="pt-8">
